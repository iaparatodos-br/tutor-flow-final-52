...
CREATE POLICY IF NOT EXISTS "Teachers can select their reports"
ON public.class_reports FOR SELECT
USING (auth.uid() = teacher_id);

CREATE POLICY IF NOT EXISTS "Teachers can insert their reports"
ON public.class_reports FOR INSERT
WITH CHECK (auth.uid() = teacher_id);

CREATE POLICY IF NOT EXISTS "Teachers can update their reports"
ON public.class_reports FOR UPDATE
USING (auth.uid() = teacher_id);

CREATE POLICY IF NOT EXISTS "Teachers can delete their reports"
ON public.class_reports FOR DELETE
USING (auth.uid() = teacher_id);

-- RLS: Students can view reports of their classes (individual)
CREATE POLICY IF NOT EXISTS "Students can view reports of their individual classes"
ON public.class_reports FOR SELECT
USING (
  class_id IN (
...
CREATE POLICY IF NOT EXISTS "Students can view reports of their group classes"
ON public.class_reports FOR SELECT
USING (
  class_id IN (
...
CREATE POLICY IF NOT EXISTS "Teachers can select feedbacks for their reports"
...
CREATE POLICY IF NOT EXISTS "Teachers can insert feedbacks for their reports"
...
CREATE POLICY IF NOT EXISTS "Teachers can update feedbacks for their reports"
...
CREATE POLICY IF NOT EXISTS "Teachers can delete feedbacks for their reports"
...
CREATE POLICY IF NOT EXISTS "Students can view their own feedback"
ON public.class_report_feedbacks FOR SELECT
USING (student_id = auth.uid());

-- Trigger for updated_at on feedbacks
DROP TRIGGER IF EXISTS update_class_report_feedbacks_updated_at ON public.class_report_feedbacks;
