-- Fix get_teacher_students function after guardian data refactoring
-- Remove references to non-existent guardian columns in profiles table
...
AS $$
  SELECT 
    ...
    tsr.student_guardian_name as guardian_name,
    tsr.student_guardian_email as guardian_email,
    tsr.student_guardian_phone as guardian_phone,
