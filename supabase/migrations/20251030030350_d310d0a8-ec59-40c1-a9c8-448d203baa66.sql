-- FASE 4: Atualizar RPC para não mais atualizar campos billed
...
BEGIN
  ...
  -- 3. Retornar resultado (sem mais atualizar campos billed)
...
DROP FUNCTION IF EXISTS public.create_invoice_and_mark_classes_billed(jsonb, uuid[]);